    ...
    <div class=\"carousel-inner\">
        <div class=\"carousel-item active\">
            ...
            <div class=\"carousel-caption d-md-block\">
                <h1 class=\"animated wow fadeInDown hero-heading\" data-wow-delay=\".4s\">Partnership Firm</h1>
                <h5 class=\"animated fadeInUp wow hero-sub-heading\" data-wow-delay=\".6s\">We help you to draft & execute your partnership deed within 7 days. After execution of deed, we help you to obtain PAN & TAN of partnership firm.</h5>
                <!--Btns here-->
                </div>
        </div>
