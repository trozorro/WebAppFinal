    ...
    <div class=\"carousel-inner\">
        <div class=\"carousel-item active\">
            ...
            <div class=\"carousel-caption d-md-block\">
                <h1 class=\"animated wow fadeInDown hero-heading\" data-wow-delay=\".4s\">One Person Company</h1>
...
<h1 class=\"section-title\">What is One Person Company (OPC) Registration?</h1>
</div>
</div>
        ...
        <div class=\"row\">
            ...
            <div class=\"col-md-6 col-lg-12 col-xl-4 wow animated fadeInUp\" data-wow-delay=\".2s\">
                <div class=\"about-single\">
                    ...
                    <p>OPC is sole proprietorship business with limited liability features.</p>
                </div>
            </div>
            <!-- Single About -->
            <div class=\"col-md-6 col-lg-12 col-xl-4 wow animated fadeInUp\" data-wow-delay=\".3s\">
                <div class=\"about-single\">
                    <i class=\"material-icons mdi mdi-pen\"></i>
                    <h2 class=\"subtitle\">Single Owner</h2>
                    <p>MThe key feature of OPC is One Person Company managed by a single owner.</p>
                </div>
            </div>
            <!-- Single About -->
            <div class=\"col-md-6 col-lg-12 col-xl-4 wow animated fadeInUp\" data-wow-delay=\".4s\">
                <div class=\"about-single\">
                    ...
                    <p>OPC is a separate legal entity from his/her owner in the eyes of law.</p>
                </div>
            </div>
            <!-- Single About -->
         ...
         <div class=\"row\">
            ...
            <div class=\"col-md-6 col-lg-12 col-xl-4 wow animated fadeInUp\" data-wow-delay=\".2s\">
                <div class=\"about-single\">
                    <i class=\"material-icons mdi mdi-pen\"></i>
                    <h2 class=\"subtitle\">Share Transferability</h2>
                    <p>OPC owner's equity cannot be transferred freely to others.</p>
                </div>
            </div>
            <!-- Single About -->
            <div class=\"col-md-6 col-lg-12 col-xl-4 wow animated fadeInUp\" data-wow-delay=\".3s\">
                <div class=\"about-single\">
                    ...
                    <p>OPC requires less compliances as compare to private & public limited.</p>
                </div>
            </div>
            <!-- Single About -->
            <div class=\"col-md-6 col-lg-12 col-xl-4 wow animated fadeInUp\" data-wow-delay=\".4s\">
                <div class=\"about-single\">
                    <i class=\"material-icons mdi mdi-pen\"></i>
                    <h2 class=\"subtitle\">Nomination</h2>
                    <p>One nominee required who will take over OPC in case owner absence.</p>
                </div>
            </div>
            <!-- Single About -->
