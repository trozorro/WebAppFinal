    ...
    <div class=\"carousel-inner\">
        <div class=\"carousel-item active\">
            ...
            <div class=\"carousel-caption d-md-block\">
                <h1 class=\"animated wow fadeInDown hero-heading\" data-wow-delay=\".4s\">Sole Proprietorship</h1>
                <h5 class=\"animated fadeInUp wow hero-sub-heading\" data-wow-delay=\".6s\">We can help you set up your Sole Proprietorship business in least time while you focus fully in your core business.</h5>
                <!--Btns here-->
                </div>
        </div>
